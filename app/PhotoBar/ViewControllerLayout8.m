...
#import "ViewControllerLayout8.h"

@implementation ViewControllerLayout8
...
-(void)setInitialValues {
    ...
    self.pathComponent = @"layout8_image";
    
    self.defaultsKey = @"layout8_needsUpdate";
