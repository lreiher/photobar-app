...
#import "TodayViewControllerLayout4.h"
#import <Photos/Photos.h>

@implementation TodayViewControllerLayout4
...
-(void)viewWillAppear:(BOOL)animated {
    ...
    [self setPreferredContentSize:CGSizeMake(0, self.view.frame.size.width / 4 * 3)];
}

- (void)widgetActiveDisplayModeDidChange:(NCWidgetDisplayMode)activeDisplayMode
                         withMaximumSize:(CGSize)maxSize {

    CGSize preferredSize = CGSizeMake(0, self.view.frame.size.width / 4 * 3);
...
-(void)loadImages {
    ...
    NSString* pathComponent = @"layout4_image";
